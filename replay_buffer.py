...
class SimpleReplayPool(object):
    ...
    def add_episode(self, episode):
        # WIP: you can write more speed up code.
        observations = episode['states']
        actions = episode['actions']
        rewards = episode['rewards']
        terminals = episode['terminals']
        for o, a, r, t in zip(observations, actions, rewards, terminals):
            self.add_sample(o, a, r, t)
    ...
    def random_batch(self, batch_size):
        ...
        return dict(
            ...
            next_states=self._observations[transition_indices]
        )
